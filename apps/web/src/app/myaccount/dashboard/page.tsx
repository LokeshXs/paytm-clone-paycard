    ...
    <main className="p-12 flex">
      ...
      <div className="flex-1  p-4">
        <div className="space-y-3 ">
          ...
          <div className="h-64 bg-primary rounded-2xl flex flex-col overflow-hidden max-w-[400px]">
            <div className="flex-1 p-2 flex items-end">
              <p className="text-xl text-primary-foreground h-fit w-fit">{session?.user?.name}</p>
            </div>
            <div className="px-6 py-6 bg-secondary ">
              <p className="text-4xl font-semibold text-primary">{totalBalance}</p>
            </div>
          </div>
        </div>
      </div>
